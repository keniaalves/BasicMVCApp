...
namespace BasicMVCApp.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Document,Type,Active,Id")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Document,Type,Active,Id")] Supplier supplier)
        {
            if (id != supplier.Id)
            {
                return NotFound();
